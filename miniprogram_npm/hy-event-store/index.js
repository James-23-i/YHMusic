...
__DEFINE__(1644197421554, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1644197421555,"./event-store":1644197421556}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1644197421555, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1644197421556, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1644197421555,"./utils":1644197421557}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1644197421557, function(require, module, exports) {
...
return __REQUIRE__(1644197421554);
})()
